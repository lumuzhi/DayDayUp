 ...
 */
#define UFFS_MAX_PAGE_SIZE		BSP_FSMC_NAND_PAGE_BYTE_SIZE//2048

/**
 * \def UFFS_MAX_SPARE_SIZE
 */
#define UFFS_MAX_SPARE_SIZE     BSP_FSMC_NAND_PAGE_OOB_SIZE//((UFFS_MAX_PAGE_SIZE / 256) * 8)

/**
 * \def UFFS_MAX_ECC_SIZE
 */
#define UFFS_MAX_ECC_SIZE       BSP_FSMC_NAND_ECC_CODEWORD_SIZE//((UFFS_MAX_PAGE_SIZE / 256) * 5)
