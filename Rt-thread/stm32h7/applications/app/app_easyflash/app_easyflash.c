...
#define W25Q256_CS_PIN        GET_PIN(B,  10)
...
void app_easyflash_init(void)
{
    ...
    stm32_qspi_bus_attach_device("qspi1", "qspi1_0", W25Q256_CS_PIN, 4, RT_NULL, RT_NULL);



//    rt_hw_spi_device_attach("spi1", "spi1_0", GPIOA, GPIO_PIN_15);
    if(rt_sfud_flash_probe("W25Q256", "qspi1_0") == RT_NULL)
    {
